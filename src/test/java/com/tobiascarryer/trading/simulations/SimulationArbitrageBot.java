...
import com.tobiascarryer.trading.simulations.exchanges.SimulationBinanceExchange;
import com.tobiascarryer.trading.simulations.exchanges.SimulationCryptopiaExchange;
import com.tobiascarryer.trading.simulations.exchanges.SimulationQuadrigaCXExchange;

import java.util.HashMap;
import java.math.BigDecimal;
import java.math.RoundingMode;

public class SimulationArbitrageBot {
	 ...
	 */
	public SimulationArbitrageBot(String minorCurrency, BigDecimal targetProfit) {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String[] majorCurrenciesToArbitrage = {"ETH", "LTC"};
		Exchange binance = new SimulationBinanceExchange("KEY", "SECRET", true);
		Exchange cryptopia = new SimulationCryptopiaExchange("KEY", "SECRET");
		Exchange quadriga = new SimulationQuadrigaCXExchange("KEY", "SECRET", "CLIENTID", minorCurrency.toUpperCase().equals("CAD")||minorCurrency.toUpperCase().equals("USD"));
		...
		SimulationArbitrageBot bot = new SimulationArbitrageBot(minorCurrency, targetProfit);
